"""Centralized data processing utilities for usage tracking.

This module provides unified data processing functionality for timestamp parsing,
token extraction, and data conversion.
"""
...
class TimestampProcessor:
    ...
    def parse_timestamp(
        self, timestamp_value: str | float | datetime | None,
    ) -> datetime | None:
