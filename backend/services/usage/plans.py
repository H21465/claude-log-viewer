"""Centralized plan configuration for Claude usage monitoring.
...
class PlanType(str, Enum):
    ...
    def from_string(cls, value: str) -> "PlanType":
        ...
        try:
            ...
            raise ValueError(f"Unknown plan type: {value}") from None
...
class Plans:
    ...
    @classmethod
    def get_token_limit(cls, plan: str, blocks: list[dict] | None = None) -> int:
        ...
        # Note: P90 calculation is not yet implemented
...
def get_token_limit(plan: str, blocks: list[dict] | None = None) -> int:
